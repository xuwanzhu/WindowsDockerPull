...
```powershell
-i swr.cn-south-1.myhuaweicloud.com/hw36423330/editor-2d:wip-jinlu-c41be194
```

指定架构：

```powershell
-i swr.cn-south-1.myhuaweicloud.com/hw36423330/editor-2d:wip-jinlu-c41be194 -a arm64v8
```

开启 debug：

```powershell
-i swr.cn-south-1.myhuaweicloud.com/hw36423330/editor-2d:wip-jinlu-c41be194 --debug
```

也可以把程序名一起输入，DockerPullAuto 会自动去掉程序名再调用原始工具：

```powershell
DockerPull.exe -i swr.cn-south-1.myhuaweicloud.com/hw36423330/editor-2d:wip-jinlu-c41be194 -a amd64
```
